...
export default function Body({ auth_token }) {
      ...
      content: (
        <div className="px-4 sm:px-6">
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            <h3 className="text-sm sm:text-base font-bold text-black">Market Scanner</h3>
            <span className="text-xs sm:text-sm text-blue-400">May 13</span>
          </div>

          <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
            {["MSFT", "AAPL", "NVDA"].map((ticker) => (
              <div key={ticker} className="bg-gray-800 bg-opacity-70 rounded-lg p-2 sm:p-3 flex justify-between">
                <span className="text-xs sm:text-sm font-medium">{ticker}</span>
                <span className="text-xs sm:text-sm text-green-400">+{Math.floor(Math.random() * 5) + 1}%</span>
              </div>
            ))}
          </div>

          <div className="h-32 sm:h-40 bg-gradient-to-b from-blue-800 to-blue-900 bg-opacity-50 rounded-lg mb-4 sm:mb-6 flex items-center justify-center">
            <div className="text-center">
              <div className="text-xs sm:text-sm text-blue-300 mb-2">Accumulation Index</div>
              <div className="text-lg sm:text-xl font-bold text-white">78.4</div>
            </div>
          </div>

          <motion.button
            className="w-full bg-blue-500 text-white text-xs sm:text-sm rounded-full py-2 sm:py-3 font-medium min-h-[40px]"
            whileTap={{ scale: 0.95 }}
          >
            Scan Markets
          </motion.button>
    ...
    },
    {
      ...
      content: (
        <div className="px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            <h3 className="text-sm sm:text-base font-bold text-black">Quality Signals</h3>
            <span className="text-xs sm:text-sm text-blue-400">Quality: 9.2</span>
          </div>

          <div className="space-y-2 mb-4 sm:mb-6">
            {["ROE", "FCF Margin", "Debt/EBITDA", "ROIC"].map((metric) => (
              <div key={metric} className="flex justify-between items-center py-1 sm:py-2">
                <span className="text-xs sm:text-sm text-gray-400">{metric}</span>
                <div className="flex items-center">
                  <div className="w-16 sm:w-20 h-2 bg-gray-700 rounded-full overflow-hidden mr-2">
                    <motion.div
                  ...
                  <span className="text-xs sm:text-sm text-white">{Math.floor(Math.random() * 5) + 6}/10</span>
                </div>
              </div>
            ))}
          </div>

          <div className="h-40 sm:h-48 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg mb-4 sm:mb-6 p-3 sm:p-4">
            <div className="text-xs sm:text-sm text-gray-400 mb-2 sm:mb-3">MSFT Performance</div>
  ...
  const marketNewsUI = (
    <div className="pb-4 sm:pb-6">
      ...
      <div className="px-3 sm:px-4 py-2 sm:py-3">
        <h3 className="text-xs sm:text-sm font-bold mb-2 sm:mb-3 text-black">Market News</h3>
        ...
        <div className="space-y-2 sm:space-y-3">
          {marketNews.map((news, idx) => (
            ...
            >
              <h4 className="text-[10px] sm:text-xs font-semibold mb-1">{news.headline}</h4>
              <p className="text-[9px] sm:text-[10px] text-gray-400 line-clamp-2">{news.summary}</p>
              <div className="flex justify-between mt-1">
                <span className="text-[8px] sm:text-[9px] text-gray-500">{news.source}</span>
                <span className="text-[8px] sm:text-[9px] text-blue-400">{news.timestamp.split(",")[0]}</span>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mt-2 sm:mt-3">
          <motion.button
            className="w-full bg-blue-500 text-white text-[10px] sm:text-xs rounded-full py-1 sm:py-1.5 font-medium min-h-[36px]"
            whileTap={{ scale: 0.95 }}
          >
            Refresh
          </motion.button>
  ...
  const premiumFeaturesUI = (
    <div className="px-4 sm:px-6 py-6 sm:py-8">
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <h3 className="text-sm sm:text-base font-bold text-black">Premium Features</h3>
        <span className="text-xs sm:text-sm text-blue-400">Unlock Now</span>
      </div>
      ...
      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
        {["Institutional Signals", "Quality Analysis", "Price Targets"].map((feature) => (
          <motion.div
            ...
            className="bg-black rounded-lg p-2 sm:p-3 flex justify-between"
          >
            <span className="text-xs sm:text-sm font-medium">{feature}</span>
            <svg className="w-4 sm:w-5 h-4 sm:h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-blue-600 rounded-lg p-4 sm:p-5 mb-4 sm:mb-6">
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <span className="text-xs sm:text-sm font-medium">Premium Plan</span>
          <span className="text-[10px] sm:text-xs bg-blue-600 px-1.5 sm:px-2 py-0.5 rounded-full">Save 20%</span>
        </div>
        <div className="text-lg sm:text-xl font-bold">
          Rs.299<span className="text-xs sm:text-sm font-normal">/month</span>
        </div>
        <div className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">Billed annually</div>
      </div>
